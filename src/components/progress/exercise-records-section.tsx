...
export function ExerciseRecordsSection({ prs }: ExerciseRecordsSectionProps) {
    return (
        <div id="exercises-weight-section" className="bg-neutral-900/20 backdrop-blur-3xl border border-white/5 rounded-4xl overflow-hidden shadow-2xl scroll-mt-24 relative">
            ...
            <div className="border-b border-white/5 p-4 sm:p-6 md:p-8 flex items-center justify-between bg-black/20 relative z-10">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <h3 className="text-lg sm:text-xl font-black text-white uppercase italic tracking-tighter">Biblioteca de Récords</h3>
                        ...
                        >
                            <div className="flex items-center gap-6 flex-1 min-w-0">
                                ...
                                <div className="min-w-0 space-y-1">
                                    <h4 className="font-black text-white text-base sm:text-lg uppercase italic tracking-tight truncate group-hover:text-blue-500 transition-colors">{pr.exercise}</h4>
