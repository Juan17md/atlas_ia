...
import { Trophy, LayoutDashboard, Zap, Sparkles } from "lucide-react";
...
export function WorkoutCompletedView() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[85vh] px-6 text-center relative overflow-hidden">
            ...
            <div className="relative space-y-12 max-w-2xl w-full">
                {/* Victory Visual */}
                <div className="relative mx-auto w-36 h-36 md:w-44 md:h-44 flex items-center justify-center group">
                    ...
                    <div className="absolute inset-3 border border-emerald-500/20 rounded-full border-dashed" />
                    ...
                    <Trophy className="w-16 h-16 md:w-20 md:h-20 text-amber-500 relative z-10 drop-shadow-[0_0_25px_rgba(245,158,11,0.5)]" />
                ...
                <div className="space-y-6">
                    <div className="inline-flex items-center gap-3 px-6 py-2 rounded-2xl bg-emerald-600/10 border border-emerald-600/20 text-emerald-400">
